//! Bruit de valeur en arithmétique entière. Suffisant pour un terrain de
//! phase 0 ; sera remplacé par une génération plus riche en phase 1.
...
pub fn value_noise(seed: u64, x: i32, y: i32, cell: i32) -> i32 {
    ...
    // Lissage en S (smoothstep entier) pour éviter les arêtes de cellule.
    let sx = smooth(fx);
    let sy = smooth(fy);
...
/// Somme de deux octaves, résultat dans `0..=255`.
